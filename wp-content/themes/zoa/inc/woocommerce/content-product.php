...
if ( ! function_exists( 'zoa_sale_flash' ) ) {
...
if ( ! function_exists( 'zoa_get_variation_attribute_options_html' ) ) {
...
if ( ! function_exists( 'zoa_swatch_html' ) ) {
        ...
        if( $variation ) {
            ...
            foreach( $attributes as $key ) {
                ...
                foreach( $vars as $key ) {
                     ...
                     */
					$img_src = isset( $key['image_src'] ) ? $key['image_src'] : wp_get_attachment_image_src( $key['image_id'], $size );
...
if ( ! function_exists( 'zoa_template_loop_product_title' ) ) {
