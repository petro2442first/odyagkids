...
zoa_Kirki::add_field(
	'zoa', array(
		'type'     => 'switch',
		'label'    => esc_html__( 'Load More Product', 'zoa' ),
...
// Show Default add to cart button instead icon.
zoa_Kirki::add_field(
	'zoa', array(
		'type'        => 'switch',
		'settings'    => 'default_add_to_cart_button',
		'label'       => esc_attr__( 'Display Default Add To Cart Button', 'zoa' ),
		'description' => esc_html__( 'Show Default Add to cart button instead Icon', 'zoa' ),
		'section'     => 'shop',
		'default'     => false,
		'choices'     => array(
			'off' => esc_attr__( 'Off', 'zoa' ),
